...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='/home/gabriel/kodifly-pcdet/output/home/gabriel/kodifly-pcdet/tools/cfgs/kitti_models/IA-SSD_loco/default/ckpt/best_ckpt.pth', help='checkpoint to start from')
